...
# 破解二进制文件下载地址：[release](https://github.com/moeleo/crack-soga-v2ray/releases)
...
``` bash
sudo bash < <(curl -Ls https://raw.githubusercontent.com/moeleo/crack-soga-v2ray/master/install.sh)
```
