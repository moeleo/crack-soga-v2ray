...
install_soga() {
    ...
    if  [ $# == 0 ] ;then
        ...
        wget -N --no-check-certificate -O /usr/local/soga.tar.gz https://github.com/moeleo/crack-soga-v2ray/archive/${last_version}.tar.gz
        if [[ $? -ne 0 ]]; then
        ...
        last_version=$1
        url="https://github.com/moeleo/crack-soga-v2ray/archive/${last_version}.tar.gz"
